  ...
  return (
    <div className='narrative-block section' id='price' style={{ marginTop: "20px", marginBottom: "20px" , maxWidth: "800px"}} >
      ...
      <p>
        ...
        we see a concerning price growth which is so large, the growth in income is nearly fully overshadowed. Specifically, switching to the income view allows to see a near 2x growth in
        median income, while the home price in some neighborhoods has tripled.
      </p>
      </div>
