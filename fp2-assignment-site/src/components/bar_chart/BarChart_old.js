...
const BarChart = () => {
  ...
  useEffect(() => {
    ...
    */
    ...
    /* // 1) create a tooltip at the top level
    ...
    const updateAnimations = () => {
      ...
      line2.attr('stroke-dashoffset', line2Length * (1 - Math.min(progress * 2, 1))); // Second half of progress
      // if (progress > 0.5) {
      ...
      // Fade in bars
      bars
        .attr('opacity', Math.max(0, Math.min((progress - 0.5) * 2, 1))) // Fade in during first half
